...
<head>
  ...
  <title>Create Class | SHAIMEURCoders</title>
  <!-- Google Fonts -->
  ...
  <div class="flex h-screen flex-col">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto p-8 flex justify-center items-start">
        <div
          class="w-full max-w-xl bg-white dark:bg-slate-900 border border-paper-border rounded-xl shadow-xl overflow-hidden notebook-ruled">
          ...
          <form action="/admin/submitClass" method="POST" class="p-8 space-y-6">
            <div class="space-y-2">
              <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Class Name</label>
              <input type="text" name="name" required placeholder="e.g. Promo 2024"
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="space-y-2">
                <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Formation</label>
              ...
              <div class="space-y-2">
                <label class="block text-xs font-black uppercase tracking-widest text-slate-400">School Year</label>
                <input type="text" name="school_year" required placeholder="2023-2024"
                  class="w-full bg-slate-50 dark:bg-slate-800 border-paper-border rounded-lg py-3 px-4 text-sm font-bold focus:ring-primary focus:border-primary">
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="space-y-2">
                <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Grade</label>
                <select name="grade"
                  class="w-full bg-slate-50 dark:bg-slate-800 border-paper-border rounded-lg py-3 px-4 text-sm font-bold focus:ring-primary focus:border-primary">
              ...
              <div class="space-y-2">
                <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Assigned
                  Teacher</label>
