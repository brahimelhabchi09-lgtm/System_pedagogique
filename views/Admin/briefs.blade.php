...
<head>
  ...
  <title>Manage Briefs | SHAIMEURCoders</title>
  <!-- Google Fonts -->
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto p-8">
        <div class="mb-8 flex justify-between items-center">
          <h1 class="text-4xl font-black tracking-tight text-academic-olive dark:text-white">Briefs Management</h1>
          <a href="/admin/addBrief"
            ...
            <tbody class="divide-y divide-paper-border">
              ...
              <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                <td class="px-6 py-4 text-sm font-bold text-slate-900 dark:text-white">
                  <?= htmlspecialchars($brief->getTitle()) ?></td>
                <td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 font-medium">
                  <?= htmlspecialchars($brief->getSprintName() ?? 'N/A') ?></td>
                <td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 font-medium">
                  <?= htmlspecialchars($brief->getDateDue()) ?></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
