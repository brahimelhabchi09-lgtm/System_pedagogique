...
<head>
  ...
  <title>Create Sprint | SHAIMEURCoders</title>
  <!-- Google Fonts -->
        ...
        <div>
          ...
          <div class="flex flex-col gap-1">
            ...
            <a class="flex items-center gap-3 rounded-lg bg-primary/10 px-4 py-2.5 text-academic-olive transition-all"
              ...
              <span class="text-sm font-bold">Sprints</span>
            </a>
            <a class="flex items-center gap-3 rounded-lg px-4 py-2.5 text-slate-500 hover:bg-slate-50 hover:text-academic-olive transition-all"
              href="/admin/skills">
      ...
      <main class="flex-1 overflow-y-auto p-8 flex justify-center items-start">
        <div
          ...
          <div class="bg-primary px-8 py-6">
            <h2 class="text-2xl font-black text-background-dark flex items-center gap-3">
              <span class="material-symbols-outlined">bolt</span>
              INITIALIZE SPRINT CYCLE
            </h2>
          </div>

          <form action="/admin/submitSprint" method="POST" class="p-8 space-y-6">
            <div class="space-y-1">
              <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Sprint
                Designation</label>
              <input type="text" name="name" required placeholder="e.g. Sprint 01: Core Web Concepts"
                class="w-full bg-slate-50 dark:bg-slate-800 border-paper-border rounded-lg py-3 px-4 text-sm font-bold focus:ring-primary focus:border-primary uppercase tracking-tighter">
            </div>

            <div class="space-y-1">
              <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Pedagogical
                Description</label>
              <textarea name="description" rows="3" placeholder="Define the focus of this cycle..."
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="space-y-1">
                <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Commencement
                  Date</label>
              ...
              <div class="space-y-1">
                <label class="block text-xs font-black uppercase tracking-widest text-slate-400">Conclusion Date</label>
