...
<head>
  ...
  <title>Personnel Record | SHAIMEURCoders</title>
  <!-- Google Fonts -->
  ...
  <div class="flex h-screen flex-col">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <aside
        ...
        <div>
          <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-4">Staff Registry</h3>
          <div class="flex flex-col gap-1">
            <a class="flex items-center gap-3 rounded-lg bg-primary/10 px-4 py-2.5 text-academic-olive transition-all"
              href="/admin/addFormateur">
              <span class="material-symbols-outlined text-xl">person_add</span>
              <span class="text-sm font-bold">Add Instructor</span>
            </a>
            <a class="flex items-center gap-3 rounded-lg px-4 py-2.5 text-slate-500 hover:bg-slate-50 hover:text-academic-olive transition-all"
              ...
              <span class="text-sm font-medium">Instructor List</span>
            </a>
          </div>
        </div>
      </aside>
      ...
      <main class="flex-1 overflow-y-auto p-12 flex justify-center items-start">
        <div
          ...
          <div class="mb-12 border-b border-paper-border pb-8">
            <p class="text-[10px] font-black uppercase tracking-[0.5em] text-academic-blue mb-2">Internal Personnel
              Dossier</p>
            <h1 class="text-4xl font-black text-academic-olive dark:text-white uppercase tracking-tighter">New
              Instructor Record</h1>
          </div>

          <form action="/admin/submitFormateur" method="POST" class="space-y-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div class="space-y-8">
                <div class="grid grid-cols-2 gap-8">
                  <div class="space-y-1">
                    <label class="text-[10px] font-black uppercase tracking-widest text-slate-400">Given Name</label>
                    <input type="text" name="first_name" required placeholder="e.g. Liam"
                      class="vintage-input w-full text-lg">
                  </div>
                  <div class="space-y-1">
                    <label class="text-[10px] font-black uppercase tracking-widest text-slate-400">Surname</label>
                    <input type="text" name="last_name" required placeholder="e.g. Wilson"
                      class="vintage-input w-full text-lg">
                  </div>
                </div>

                <div class="space-y-1">
                  <label class="text-[10px] font-black uppercase tracking-widest text-slate-400">Professional Email
                    Address</label>
                  <input type="email" name="email" required placeholder="instructor@shaimeurcoders.edu"
                    class="vintage-input w-full text-lg">
                </div>
                ...
                <div class="grid grid-cols-2 gap-8">
                  <div class="space-y-1">
                    ...
                    <input type="text" name="phone" placeholder="+1..." class="vintage-input w-full text-lg">
                  </div>
                  <div class="space-y-1">
                    <label class="text-[10px] font-black uppercase tracking-widest text-slate-400">Age</label>
                    <input type="number" name="age" placeholder="30" class="vintage-input w-full text-lg">
                  </div>
                </div>

                <div class="space-y-1">
                  <label class="text-[10px] font-black uppercase tracking-widest text-slate-400">Access Key
                    (Password)</label>
              ...
              <div class="flex flex-col items-center justify-center space-y-4">
                ...
                <p class="text-[9px] text-slate-400 uppercase tracking-widest font-bold">Affix Official Portrait</p>
              </div>
            </div>
            ...
            <div class="pt-12 border-t border-paper-border flex items-center justify-between">
              <div class="flex items-center gap-2 text-academic-blue italic text-xs">
                ...
                <span>I verify the accuracy of this pedagogical record.</span>
              </div>
