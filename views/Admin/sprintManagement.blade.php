...
<head>
  ...
  <title>Sprint Registry | SHAIMEURCoders</title>
  <!-- Google Fonts -->
      ...
      <main class="flex-1 overflow-y-auto">
        <div class="p-8">
          <div class="mb-8 flex justify-between items-end">
            <div>
              <h1 class="text-5xl font-black tracking-tight text-academic-olive dark:text-white">Sprint Registry</h1>
              <p class="text-academic-blue text-lg mt-2 font-medium italic">Comprehensive record of pedagogical blocks.
              </p>
            </div>
            <a href="/admin/createSprint"
              class="flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-black text-background-dark shadow-lg shadow-primary/20 hover:shadow-xl hover:-translate-y-0.5 transition-all">
            ...
            <table class="min-w-full leading-normal">
              <thead>
                <tr class="bg-slate-50 dark:bg-slate-800">
                  <th
                    class="px-6 py-4 border-b border-paper-border text-left text-xs font-black text-slate-500 uppercase tracking-widest">
                    Name</th>
                  <th
                    class="px-6 py-4 border-b border-paper-border text-left text-xs font-black text-slate-500 uppercase tracking-widest">
                    Duration</th>
                  <th
                    class="px-6 py-4 border-b border-paper-border text-center text-xs font-black text-slate-500 uppercase tracking-widest">
                    Status</th>
                  <th
                    class="px-6 py-4 border-b border-paper-border text-right text-xs font-black text-slate-500 uppercase tracking-widest">
                    Actions</th>
                </tr>
              </thead>
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  <td class="px-6 py-5">
                    <div class="flex flex-col">
                      <span class="font-bold text-lg text-slate-900 dark:text-white">Web Fundamentals</span>
                      <span class="text-xs text-slate-400 font-medium italic">#SPR-2024-001</span>
                    </div>
                  </td>
                  <td class="px-6 py-5">
                  ...
                  <td class="px-6 py-5 text-center">
                    <span
                      class="px-3 py-1 bg-primary/20 text-academic-olive rounded-full text-xs font-bold uppercase tracking-tighter">Active</span>
                  </td>
                  <td class="px-6 py-5 text-right">
                    ...
                    <button class="p-2 text-slate-400 hover:text-red-500 transition-colors"><span
                        class="material-symbols-outlined">archive</span></button>
                  </td>
                </tr>
              </tbody>
            </table>
